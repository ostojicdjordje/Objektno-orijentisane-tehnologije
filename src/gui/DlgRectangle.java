...
public class DlgRectangle extends JDialog {
    ...
    private JTextField txtHeight     = new JTextField(8);
    ...
    public DlgRectangle(Frame parent, String title) {
    ...
    private void buildUi() {
        ...
        pnlFields.add(new JLabel("Upper-left X:"));  pnlFields.add(txtX);
        pnlFields.add(new JLabel("Upper-left Y:"));  pnlFields.add(txtY);
        pnlFields.add(new JLabel("Width:"));          pnlFields.add(txtWidth);
        pnlFields.add(new JLabel("Height:"));         pnlFields.add(txtHeight);
    ...
    private boolean validateInput() {
        try {
            ...
            if (w <= 0 || h <= 0) {
                JOptionPane.showMessageDialog(this, "Width and Height must be > 0!", "Validation Error", JOptionPane.ERROR_MESSAGE);
                return false;
            }
    ...
    public void setWidth(int w)       { txtWidth.setText(String.valueOf(w)); }
    public void setHeight(int h)      { txtHeight.setText(String.valueOf(h)); }
    ...
    public int     getWidthValue()  { return Integer.parseInt(txtWidth.getText().trim()); }
    public int     getHeightValue() { return Integer.parseInt(txtHeight.getText().trim()); }
